...
public object DogGrpcKt {
  ...
  public val playMethod: MethodDescriptor<PlayRequest, PlayReply>
    @JvmStatic
    get() = DogGrpc.getPlayMethod()
  ...
  public class DogCoroutineStub @JvmOverloads constructor(
     ...
     * @return The single response from the server.
     */
    public suspend fun play(request: PlayRequest, headers: Metadata = Metadata()): PlayReply =
        unaryRpc(
      channel,
      DogGrpc.getPlayMethod(),
      request,
      callOptions,
      headers
    )
  ...
  public abstract class DogCoroutineImplBase(
    ...
    /**
     * Returns the response to an RPC for animals.Dog.Play.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
     ...
     * @param request The request from the client.
     */
    public open suspend fun play(request: PlayRequest): PlayReply = throw
        StatusException(UNIMPLEMENTED.withDescription("Method animals.Dog.Play is unimplemented"))
    ...
    public final override fun bindService(): ServerServiceDefinition =
      ...
      .addMethod(unaryServerMethodDefinition(
      context = this.context,
      descriptor = DogGrpc.getPlayMethod(),
      implementation = ::play
    )).build()
  }
}
