...
public final class DogGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<io.grpc.examples.animals.PlayRequest,
      io.grpc.examples.animals.PlayReply> getPlayMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Play",
      requestType = io.grpc.examples.animals.PlayRequest.class,
      responseType = io.grpc.examples.animals.PlayReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.grpc.examples.animals.PlayRequest,
      io.grpc.examples.animals.PlayReply> getPlayMethod() {
    io.grpc.MethodDescriptor<io.grpc.examples.animals.PlayRequest, io.grpc.examples.animals.PlayReply> getPlayMethod;
    if ((getPlayMethod = DogGrpc.getPlayMethod) == null) {
      synchronized (DogGrpc.class) {
        if ((getPlayMethod = DogGrpc.getPlayMethod) == null) {
          DogGrpc.getPlayMethod = getPlayMethod =
              io.grpc.MethodDescriptor.<io.grpc.examples.animals.PlayRequest, io.grpc.examples.animals.PlayReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Play"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.grpc.examples.animals.PlayRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.grpc.examples.animals.PlayReply.getDefaultInstance()))
              .setSchemaDescriptor(new DogMethodDescriptorSupplier("Play"))
              .build();
        }
      }
    }
  ...
  public static abstract class DogImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void play(io.grpc.examples.animals.PlayRequest request,
        io.grpc.stub.StreamObserver<io.grpc.examples.animals.PlayReply> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                io.grpc.examples.animals.PlayRequest,
                io.grpc.examples.animals.PlayReply>(
                  this, METHODID_PLAY)))
          .build();
    }
  }
  ...
  public static final class DogBlockingStub extends io.grpc.stub.AbstractBlockingStub<DogBlockingStub> {
    ...
    /**
     */
    public io.grpc.examples.animals.PlayReply play(io.grpc.examples.animals.PlayRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class DogFutureStub extends io.grpc.stub.AbstractFutureStub<DogFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<io.grpc.examples.animals.PlayReply> play(
        io.grpc.examples.animals.PlayRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_BARK:
          ...
          break;
        case METHODID_PLAY:
          serviceImpl.play((io.grpc.examples.animals.PlayRequest) request,
              (io.grpc.stub.StreamObserver<io.grpc.examples.animals.PlayReply>) responseObserver);
          break;
        default:
